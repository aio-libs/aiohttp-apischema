...
def _get_version_info():
    PATH_TO_INIT_PY = os.path.join(
        os.path.dirname(__file__), "..", "aiohttp_apischema", "__init__.py"
    )
...
htmlhelp_basename = "aiohttp_apischemadoc"
...
latex_documents = [
    (
        "index",
        "aiohttp_apischema.tex",
        "aiohttp\\_apischema Documentation",
        "aio-libs",
        "manual",
    ),
]
...
man_pages = [
    ("index", "aiohttp_apischema", "aiohttp_apischema Documentation", ["aio-libs"], 1)
]
...
texinfo_documents = [
    (
        "index",
        "aiohttp_apischema",
        "aiohttp_apischema Documentation",
        "aio-libs",
        "aiohttp_apischema",
